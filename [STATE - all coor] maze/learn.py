...
def main(epochs = 100, create_new_qtable = False, regressor = False):
    ...
    if regressor: # NOT YET IMPLEMENTED
        pass
    ...
    for epoch in range(initial_epoch + 1, initial_epoch + epochs + 1):
        ...
        passed_by, player_maze, new_coors_found = player_perspective(maze, player_coor, [END_COOR] + [coor for coor in maze if coor[0] == 0 or coor[0] == WIDTH + 1 or coor[1] == 0 or coor[1] == HEIGHT + 1])
        ...
        while not done and number_of_actions < MAX_ACTIONS:            
            ...
            if random() < exploration_rate: # explore
                ...
                action = evaluate_action(player_maze)
            state = player_maze.copy()
            if action == 0:
            ...
            passed_by, player_maze, new_coors_found = player_perspective(maze, player_coor, passed_by)
            ...
            # Update Q-table
            resultant_state = player_maze.copy()
...
main(epochs = 500, create_new_qtable = True, regressor = False)
